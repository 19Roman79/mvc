...
$router->add('user/show', ['controller' => 'Users', 'action' => 'show']);
$router->add('user/create', ['controller' => 'Users', 'action' => 'create']);
$router->add('item', ['controller' => 'Items', 'action' => 'index']);
$router->add('item/show', ['controller' => 'Items', 'action' => 'show']);
$router->add('item/create', ['controller' => 'Items', 'action' => 'create']);
